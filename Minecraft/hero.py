...
key_turn_up = 'u'    #поворт камеры наверх (а мира - вниз)
key_turn_down = 'j'
...
key_loadmap = 'l'  # Загрузка карты
key_p = 'p'  # смена текстур
...
class Hero():
    ...
    def accept_events(self):
        ...
        base.accept(key_turn_down + '-repeat', self.turn_up)
        ...
        base.accept(key_p, self.t_texture) #
